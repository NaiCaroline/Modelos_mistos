...
rio::export(Dados_crit, 'Simu_CenarioIII_Criterios.xlsx')
rio::export(Res_amostra, 'Simu_CenarioIII_Resultados.xlsx')
rio::export(Dados_pred, 'Simu_CenarioIII_Preditos.xlsx')

save.image("Simu_CenarioIII.RData")

txtStart("ResultadosParametros_CenarioIII.txt")

...
rio::export(Dados_crit, 'Simu_CenarioII_Criterios.xlsx')
rio::export(Res_amostra, 'Simu_CenarioII_Resultados.xlsx')
rio::export(Dados_pred, 'Simu_CenarioII_Preditos.xlsx')

save.image("Simu_CenarioII.RData")

txtStart("ResultadosParametros_CenarioII.txt")
